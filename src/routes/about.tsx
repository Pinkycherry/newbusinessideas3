...
export const Route = createFileRoute("/about")({
  head: () =>
    metaFor(
      "About BBI — Who Writes This, and Why It Is Free",
  ...
  return (
    ...
    >
      <Section heading="The first twenty dollars">
        <p>
          Kartik Ramaswamy is an engineer. He works a corporate job in Delhi, he is from Tamil Nadu,
          and like a few million other people he has spent years quietly wanting to start something
          of his own.
        </p>
        <p>
      ...
      <Section heading="Then he did it again. Twice.">
        ...
        <p>
          Same shape of answer every time. You type your idea, it gets folded into a prompt already
          written by somebody else, and whatever comes back is what you get. Sometimes it was
          accurate. Often it was thin. Occasionally it answered a question about a completely
          different business.
        </p>
        <p>
      ...
      <Section heading="The refund policy was the part that stung">
        ...
        <p>
          That was the moment. Not the money, which he could absorb. The realisation underneath it:{" "}
      ...
      <Section heading="So they built the thing they had been looking for">
        <p>
          They bought a domain the same week, while they were still annoyed. They imagined something
          useful. They argued it into something meaningful. They built it into something scalable —
          and it is live, which is the only part of that sentence that counts.
        </p>
        <p>
          The rule they set on day one has not moved since: someone starting from zero — no capital,
          no team, no laptop, reading this on a phone at one in the morning — should get the whole
          thing. Not a preview. Not three free credits. The research, the numbers, the risks, and
          the verdict that says do not build this one.
        </p>
      </Section>

      <Section heading="Who actually makes this">
        <p>
          Four people, three of whom passed out of Anna University Regional Campus, Madurai in 2012,
          and one who is rather newer.
        </p>
      ...
      <Section heading="How an idea actually gets made here">
        <p>
          We will not pretend otherwise: AI assists the drafting. It is a tool, and refusing to use
          it would make the library smaller and no more honest.
        </p>
        <p>
          What it does not do is decide. Every blueprint is researched, checked and given its
          verdict by one of us. The founder signs off on each one before it is published — which is
          why his name, not a company name, sits in the byline.
        </p>
        <Bullets
          items={[
      ...
      <Section heading="Who gets everything free, no questions">
        <p>
          The whole library is free to read. Beyond that, there is a standing commitment, and it is
        ...
        <p className="rounded-2xl border border-accent/40 bg-accent/5 px-5 py-4 text-base font-semibold leading-relaxed text-foreground">
          ...
          charge, and including personalised guides and workflows built for your specific situation.
          Email us and say which applies to you. That is the entire process.
        </p>
        <p className="mt-4">
          Poor comes first. Zero-investment founders come second. Students, people with
          disabilities, widows and single mothers are at the top of the list, not the bottom of it.
        </p>
      </Section>

      <Section heading="Advice costs nothing, and comes with no guarantee">
        <p>
          Write to us with a real problem and a human reads it. If it needs the founder, the founder
          answers — and where it touches trademarks, business registration, workspace questions or
          raising money, he will bring in family and friends who work in finance and law.
        </p>
        <p>
          <strong className="text-foreground">Not one rupee is charged for any of that.</strong> The
          only thing we would ever charge for is a subscription to this website, to keep it running.
          Advice given in person, over email, to anyone who asks, is free and always will be.
        </p>
        <p>
          And the honest half: nobody here can promise your business will work. He will give you the
          best he has. He will not tell you it is a sure thing, because it is not, and anyone who
