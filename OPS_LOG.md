...
- 2026-09-24 · Supabase · IDEA-00330 (podcast pitch trial page) content fixed at source at the founder's request: full row backed up first to `public.ideas_idea00330_backup_20260924` (the tone agent's 11:14 version). Changed: `summary` (was generic boilerplate), `tags` (were cut off mid-word), `market_opportunity` and `pros_json` (removed two unsourced claims), `how_you_make_money`, `getting_started_steps` (scope, no booking guarantee, follow-up, revisions; brand name removed), `time_to_first_customer` (no invented timeline), and two FAQs appended (booking guarantee, credentials). No numbers added; title, SEO fields, keywords, score and links untouched. Update was guarded on `updated_at`. · Claude
