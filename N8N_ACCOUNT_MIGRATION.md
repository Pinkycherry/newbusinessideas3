...
**Currently populated: 65 of 116.** Run the idea pipeline and those sixty-five
process end to end while the other 51 are skipped and counted by `Run Summary`.
...
The remaining 51 break down by business model as:
