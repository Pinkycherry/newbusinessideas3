...
**Currently populated: 72 of 116.** Run the idea pipeline and those seventy-two
process end to end while the other 44 are skipped and counted by `Run Summary`.
...
The remaining 44 break down by business model as:

| Cluster | Count | Shared economics? |
|---|---|---|
| Marketplace / platform (two-sided) | 0 — done | yes — take rate, liquidity, LTV:CAC |
| Part-time local or physical shift | 20 | no — varies by trade |
| Part-time freelance service | 15 | no — rates differ per discipline |
